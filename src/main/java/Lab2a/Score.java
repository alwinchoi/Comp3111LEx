...
public class Score {
    ...
    /* [C] Constructor: to initialize value to the object thorugh paratmers */
    Score() {
        Quiz = 0;
        MidTExam = 0;
        FinalExam = 0;
    ...
    /* Below are Procedures [M1]. Procedures is a sub program to run several process, but not return value(s) */
    ...
    /* Below are Functions[M2]. Function is a statement that creates to run and return value(s) */
    double getScore() {
